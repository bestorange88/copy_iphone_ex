...
export default function PaymentNavBar() {
  ...
  const getActiveTab = () => {
    ...
    if (path === '/payment-platform' || path === '/payment-platform/') return 'home';
