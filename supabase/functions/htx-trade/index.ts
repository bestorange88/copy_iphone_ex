...
serve(async (req) => {
  ...
  try {
    ...
    if (apiKeysError || !apiKeys) {
      throw new Error('HTX API keys not configured');
    }
    ...
    console.error('HTX Trade Error [Internal]:', {
